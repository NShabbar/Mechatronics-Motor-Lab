...
# Source Files
SOURCEFILES=../../../../../ECE118/src/AD.c ../../../../../ECE118/src/BOARD.c ../../../../../ECE118/src/IO_Ports.c ../../../../../ECE118/src/LED.c ../../../../../ECE118/src/pwm.c ../../../../../ECE118/src/RC_Servo.c ../../../../../ECE118/src/roach.c ../../../../../ECE118/src/serial.c ../../../../../ECE118/src/timers.c Part4.c
...
${OBJECTDIR}/Part4.o: Part4.c  .generated_files/flags/default/2c0b5776f58ca6f2fd051c398b5ad35c2783c3ad .generated_files/flags/default/5c6b98b8923ce30ee24d180da03fe6585119c89b
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Part4.o.d 
	@${RM} ${OBJECTDIR}/Part4.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -fno-common -DPART2 -I"." -I"C:/ECE118/include" -MP -MMD -MF "${OBJECTDIR}/Part4.o.d" -o ${OBJECTDIR}/Part4.o Part4.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/Part4.o: Part4.c  .generated_files/flags/default/66b38ffa6d3b1275d3e1ab9a8a01652e7ad4fffc .generated_files/flags/default/5c6b98b8923ce30ee24d180da03fe6585119c89b
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Part4.o.d 
	@${RM} ${OBJECTDIR}/Part4.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -fno-common -DPART2 -I"." -I"C:/ECE118/include" -MP -MMD -MF "${OBJECTDIR}/Part4.o.d" -o ${OBJECTDIR}/Part4.o Part4.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
